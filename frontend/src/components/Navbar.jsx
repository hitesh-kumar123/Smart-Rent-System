          ...
          {location.pathname === "/" && (
            ...
            >
              <form onSubmit={handleSearchSubmit} className="w-full">
                ...
                <button
                  type="submit"
                  className="absolute right-1 top-1/2 transform -translate-y-1/2 bg-[#FF4C6D] text-white    rounded-full hover:bg-[#E03F5A] transition duration-200 flex items-center justify-center w-8 h-8 m-1"
                >
